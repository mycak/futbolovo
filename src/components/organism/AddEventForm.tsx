...
const AddEventForm = () => {
  ...
  return (
    ...
    >
      ...
      <Button
        classNames="h-[38px] bg-emerald-400 mt-6 bg-grass-45 text-xl flex items-center pl-3 pr-5 opacity-90 transition-all duration-300 col-span-2 max-w-max mx-auto hover:opacity-100"
        variant="icon"
        icon="location-dot"
        text="Dodaj"
        type="submit"
